        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            <a href={props.link2Url} className="thq-link thq-body-small">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text16">My Kundali</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text14">Blog And Content</span>
                </Fragment>
              )}
            </a>
            <div
            ...
            >
              <span className="thq-link thq-body-small">
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar8-text20">Chat With AI Astrologer</span>
                  </Fragment>
                )}
              </span>
            </div>
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-filled thq-button-animated">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text24">Login</span>
                  </Fragment>
                )}
              </span>
            </button>
                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text26">
                                  Explore your daily horoscope readings
                                </span>
                              </Fragment>
                            )}
                          </span>
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text19">My Kundali</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                      ...
                      <div className="navbar8-menu-item3">
                        ...
                        <div className="navbar8-content3">
                          <span className="navbar8-page31 thq-body-large">
                            {props.page3 ?? (
                              <Fragment>
                                <span className="navbar8-text18">Blog And Content</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text21">
                                  Learn about zodiac signs and compatibility
                                </span>
                              </Fragment>
                            )}
                          </span>
                      ...
                      <div className="navbar8-menu-item4">
                        ...
                        <div className="navbar8-content4">
                          <span className="navbar8-page41 thq-body-large">
                            {props.page4 ?? (
                              <Fragment>
                                <span className="navbar8-text23">Chat With AI Astrologer</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            {props.page4Description ?? (
                              <Fragment>
                                <span className="navbar8-text22">
                                  Get insights into planetary movements and
                                  their effects
                                </span>
                              </Fragment>
                            )}
...
Navbar8.defaultProps = {
  ...
  page3ImageSrc:
    'https://images.unsplash.com/photo-1587242563826-a438ce9e3cc8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNzIwOTI5NXw&ixlib=rb-4.0.3&q=80&w=1080',
  ...
  page3: undefined,
  page4ImageAlt: 'Chat With AI Astrologer Image',
  page1ImageAlt: 'Home Image',
  page2ImageAlt: 'My Kundali Image',
  page2: undefined,
  ...
  action2: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1685020437268-d49bcfe6cdf8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNzIwOTI5NHw&ixlib=rb-4.0.3&q=80&w=1080',
  ...
  link1: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1644074992646-47d68f8afb5c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNzIwOTI5NXw&ixlib=rb-4.0.3&q=80&w=1080',
}
